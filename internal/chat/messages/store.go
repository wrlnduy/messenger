...
func (s *PostgresStore) Save(
	...
	_, err := tx.ExecContext(ctx, `
		INSERT INTO chat_messages (message_id, chat_id, user_id, text, timestamp)
		VALUES($1, $2, $3, $4, $5)
		`,
...
func (s *PostgresStore) List(
	...
	log.Printf("Found %v messages in chat %q", len(messages), chat_id)
...
func (s *PostgresStore) History(
	...
	return &chatpb.ChatHistory{Messages: msgs}, nil
}
